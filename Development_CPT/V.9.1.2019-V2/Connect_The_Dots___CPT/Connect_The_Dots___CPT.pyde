...
def draw():
    ...
    boxx = makes_box(dots, lines, lines_to_ignore)
    
    lines_to_ignore = boxx[1]
    print(boxx)
    boxx = boxx[0]
    print(boxx)
    ...
    # print("p1", player_1_boxes, frameCount)

    # print("p2", player_2_boxes, frameCount)
...
def makes_box(dotz, linez, lines_to_ignore):
    ...
    for dott in dotz:
        ...
        for lin in linez:
            if ((a in lin) and (b in lin)) and (lin not in lines_to_ignore):
                lines_in_square += 1
                lines_to_ignore.append(lin)
            elif ((b in lin) and (c in lin)) and (lin not in lines_to_ignore):
                lines_in_square += 1
                lines_to_ignore.append(lin)
            elif ((c in lin) and (d in lin)) and (lin not in lines_to_ignore):
                lines_in_square += 1
                lines_to_ignore.append(lin)
            elif ((d in lin) and (a in lin)) and (lin not in lines_to_ignore):
                lines_in_square += 1
                lines_to_ignore.append(lin)
                
        if lines_in_square == 6:
            box_cor = dott
            
        else:
            box_cor = False
    
    # print(box_cor, lines_in_square)
    
    return [box_cor, lines_to_ignore]
